...
**Datasources**: `data/exports/transfers_flat.csv`  
**Mock version**: `v_1`  
**Derived from**: approved `docs/design-tokens.md`, approved `docs/data-source-architecture.md`, updated `docs/dashboard-plan.md`, `prototypes/tableau/v1/mock.html`
...
## Approval Checklist
- [x] Every sheet maps back to a stable ID from `docs/dashboard-plan.md`
