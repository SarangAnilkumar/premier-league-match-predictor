...
Implemented in XML:
- Live CSV datasource (`transfers_flat.csv`)
...
1. Open `prototypes/tableau/v1/dashboard.twbx`
2. Duplicate the starter dashboard to preserve a fallback copy.
3. Create calculated fields from `prototypes/tableau/v1/TABLEAU-IMPLEMENTATION.md`:
...
7. Apply styling from `docs/design-tokens.md` (colors, spacing, typography).
