...
from premier_league.analytics.formations import (  # noqa: E402
...
from premier_league.database.connection import create_db_engine, make_session_factory, session_scope  # noqa: E402
from premier_league.database.settings import DatabaseSettings  # noqa: E402
from premier_league.database.schema import create_schema  # noqa: E402
from premier_league.config import Settings  # noqa: E402
from premier_league.paths import FORMATION_READ_MODELS  # noqa: E402
...
def main() -> None:
    ...
    out_dir = FORMATION_READ_MODELS
    out_fixture_formations_primary = out_dir / "fixture_formations_primary.json"
    out_fixture_formations = out_dir / "fixture_formations.json"

    out_usage_primary = out_dir / "formation_usage_primary.json"
    out_usage_summary = out_dir / "formation_usage_summary.json"

    out_starting_formations = out_dir / "starting_formations.json"
    out_usage_full = out_dir / "formation_usage_full.json"
    out_matchups = out_dir / "formation_matchups.json"
    out_matchup_summary = out_dir / "formation_matchup_summary.json")
