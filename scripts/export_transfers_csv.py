...
from premier_league.paths import DEFAULT_DB_PATH, TRANSFERS_EXPORT_CSV  # noqa: E402

DEFAULT_DB_PATH = PROJECT_ROOT / DEFAULT_DB_PATH
DEFAULT_OUTPUT_PATH = PROJECT_ROOT / TRANSFERS_EXPORT_CSV
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to SQLite DB file (default: data/premier_league.sqlite).",
    )
    parser.add_argument(
        "--output-path",
        default=str(DEFAULT_OUTPUT_PATH),
        help="Path to output CSV (default: data/exports/transfers_flat.csv).",
    )
    parser.add_argument(
        "--season",
        default=None,
